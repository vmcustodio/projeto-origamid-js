...
export default function fetchAnimais(url, target) {
  ...
  function createAnimal(animal) {
    const div = document.createElement('div'); // criando div no js
  ...
  function animaAnimaisNumeros() {
    const animaNumeros = new AnimaNumeros('[data-numero]', '.numeros', 'ativo'); // acontecer apenas depois que o fetch ocorrer
    animaNumeros.init();
  }
